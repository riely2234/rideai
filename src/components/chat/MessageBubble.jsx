...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center mt-0.5 shadow-sm">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-gradient-to-br from-slate-800 to-slate-900 text-white" : "bg-white border border-slate-200"
                    )}>
                        {isUser ? (
                            ...
                            <ReactMarkdown 
                                ...
                                components={{
                                    ...
                                    a: ({ children, ...props }) => (
                                        <a {...props} className="text-blue-600 hover:text-blue-700 underline" target="_blank" rel="noopener noreferrer">{children}</a>
                                    ),
                                    ...
                                    blockquote: ({ children }) => (
                                        <blockquote className="border-l-3 border-slate-300 pl-4 my-2 text-slate-600 italic">
                                            {children}
                                        </blockquote>
                                    ),
                                }}
